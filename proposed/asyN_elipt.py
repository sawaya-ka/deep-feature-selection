...
np.savetxt("res/elpt_mat_mlp.csv", M_mlp, delimiter=",")
np.savetxt("res/elpt_mat_cnn.csv", M_cnn, delimiter=",")
np.savetxt("res/elpt_mat_rnn.csv", M_rnn, delimiter=",")
np.savetxt("res/elpt_mat_tr.csv",  M_tr,  delimiter=",")
